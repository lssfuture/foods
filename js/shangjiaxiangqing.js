...
* @Last Modified time: 2018-09-13 13:21:46
*/
let jia=document.querySelector("nav .content ul li:nth-child(3) .wenzi .wu img");
let jian=document.querySelector("nav .content ul li:nth-child(3) .wenzi .wu img:nth-of-type(2)");
let num=document.querySelector("nav .content ul li:nth-child(3) .wenzi .wu h6");
